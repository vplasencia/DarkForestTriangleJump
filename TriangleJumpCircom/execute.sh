...
# Compile the circuit
circom trianglejump.circom --r1cs --wasm --sym --c

# Copy the input file inside the multiplier_js directory
cp input.json trianglejump_js/input.json
...
snarkjs groth16 setup trianglejump.r1cs pot12_final.ptau trianglejump_0000.zkey

# Contribute to the phase 2 of the ceremony
snarkjs zkey contribute trianglejump_0000.zkey trianglejump_0001.zkey --name="1st Contributor Name" -v
...
snarkjs groth16 prove trianglejump_0001.zkey witness.wtns proof.json public.json

# Verify the proof
snarkjs groth16 verify verification_key.json public.json proof.json

# Generate a Solidity verifier that allows verifying proofs on Ethereum blockchain
snarkjs zkey export solidityverifier trianglejump_0001.zkey verifier.sol
